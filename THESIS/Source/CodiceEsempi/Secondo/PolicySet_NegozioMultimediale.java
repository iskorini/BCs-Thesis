...
public class PolicySet_NegozioMultimediale extends PolicySet {
	...
	public PolicySet_NegozioMultimediale(ContextRequest_Status ctxReq) throws MissingAttributeException {
		...
		addTarget(ebt);
		// Policy
		addPolicyElement(new PolicySet_BuyType0());
		addPolicyElement(new PolicySet_BuyType1());
		addPolicyElement(new PolicySet_View0());
		addPolicyElement(new PolicySet_View1());
	}

	private class PolicySet_BuyType0 extends PolicySet {// Policy per il buy di
														// Alice

		public PolicySet_BuyType0() throws MissingAttributeException {
			addId("Buy_Policy");
			// Algorithm Combining
			addCombiningAlg(it.unifi.facpl.lib.algorithm.DenyUnlessPermitGreedy.class);
			// Target
			...
			addObligation(new ObligationStatus(new FlagStatus(), Effect.PERMIT, ObligationType.M,
					new StatusAttribute("accessTypeAlice", FacplStatusType.BOOLEAN), true));
		}
		...
		private class Rule_buy extends Rule {
			...
			Rule_buy() throws MissingAttributeException {
				...
				ExpressionFunction e1 = new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class, "0",
	...
	private class PolicySet_BuyType1 extends PolicySet {// Policy per il
														// noleggio di Bob

		public PolicySet_BuyType1() throws MissingAttributeException {
			...
			// Obligation
			addObligation(new ObligationStatus(new FlagStatus(), Effect.PERMIT, ObligationType.M,
					new StatusAttribute("accessTypeBob", FacplStatusType.BOOLEAN), false));
		}
		...
		private class Rule_buy extends Rule {
			...
			Rule_buy() throws MissingAttributeException {
				...
				// Effect
				addEffect(Effect.PERMIT);
				ExpressionFunction e1 = new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class, "1",
						new AttributeName("actionType", "id"));
				ExpressionFunction e2 = new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class,
	...
	private class PolicySet_View0 extends PolicySet {// Policy per la view di
														// Alice che ha comprato

		public PolicySet_View0() throws MissingAttributeException {
	...
	private class PolicySet_View1 extends PolicySet {// Policy per la view di
														// Bob che ha noleggiato

		public PolicySet_View1() throws MissingAttributeException {
			...
			addObligation(new ObligationStatus(new AddStatus(), Effect.PERMIT, ObligationType.M,
					new StatusAttribute("counterViewFile1", FacplStatusType.INT), 1));
		}
		...
		private class Rule_view extends Rule {
			...
			Rule_view() throws MissingAttributeException {
				...
				ExpressionFunction e2 = new ExpressionFunction(it.unifi.facpl.lib.function.comparison.LessThan.class,
						...
						new StatusAttribute("tempoViewFile1", FacplStatusType.DATE), "12:06:06");
				ExpressionFunction e3 = new ExpressionFunction(it.unifi.facpl.lib.function.comparison.LessThan.class,
						new StatusAttribute("counterViewFile1", FacplStatusType.INT), 10);
