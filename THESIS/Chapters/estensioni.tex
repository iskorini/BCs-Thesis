...
\MyFigure{evalStatus.png}{Nuovo processo di valutazione in FACPL}{1}
Come si nota in figura \ref{fig:evalStatus.png} è stato aggiunto un componente alla struttura della valutazione.
