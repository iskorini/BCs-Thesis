...
di controllo all'accesso proposti negli ultimi decenni, infine viene analizzato anche un nuovo modello chiamato \textit{Usage Control}. Infine nell'ultima sezione vengono proposti due case study.
