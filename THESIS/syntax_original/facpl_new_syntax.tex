...
\\[.2cm]
{\textbf{PepAction}} & \mathit{PepAction} & ::= & \, \x{add(\mathit{Attribute}, \mathit{int})} \Sep \x{flag(\mathit{Attribute}, \mathit{boolean})} \\ 
&& & \Sep \x{sumDate(\mathit{Attribute}, \mathit{date})} \Sep \x{div(\mathit{Attribute}, \mathit{int})} \\
&& & \Sep \x{add(\mathit{Attribute}, \mathit{double})} \ \Sep \x{mul(\mathit{Attribute}, \mathit{double})} \\
&& & \Sep \x{mul(\mathit{Attribute}, \mathit{int})} \ \Sep \x{div(\mathit{Attribute}, \mathit{double})} \\
&& & \Sep \x{sub(\mathit{Attribute}, \mathit{int})} \ \Sep \x{sub(\mathit{Attribute}, \mathit{double})} \\
&& & \Sep \x{sumString(\mathit{Attribute}, \mathit{string})} \\ 
&& & \Sep \x{setValue(\mathit{Attribute}, \mathit{string})}\\
&& & \Sep \x{setDate(\mathit{Attribute}, \mathit{date})}  
\\[.2cm]
