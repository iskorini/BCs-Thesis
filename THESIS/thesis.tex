...
\newcommand{\myEnglishTitle}{Extension of the FACPL language in order to express the access policies to the resources of a system
based on past behaviour\xspace}
