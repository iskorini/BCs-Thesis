...
\emph{"Mi ritengo peggiore degli altri, ma non so quanti siano migliori di me." \break --- Enzo Ferrari} \vspace{\stretch{2}}\null
\end{flushright}
\cleardoublepage
\nocite{*}
...
\include{Chapters/estensionelibreria_new}
\include{Chapters/conclusioni}
\bibliographystyle{abbrv}
\bibliography{Chapters/bib.bib}
